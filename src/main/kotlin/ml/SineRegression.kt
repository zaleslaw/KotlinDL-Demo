...
private val model = Sequential.of(
    ...
    Dense(100, Activations.Relu, kernelInitializer = HeNormal(), biasInitializer = HeUniform(), name = "dense_1"),
    Dense(100, Activations.Relu, kernelInitializer = HeNormal(), biasInitializer = HeUniform(), name = "dense_2"),
